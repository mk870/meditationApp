...
const Footer = ({ data }) => {
  ...
  // Check if the current item is already in favorites on mount
  ...
  // Add or remove item from favorites in AsyncStorage
  ...
  return (
    <View style={styles.container}>
      {/* Heart icon toggles filled/outline based on favorite state */}
      ...
      {/* Text button toggles favorite label */}
